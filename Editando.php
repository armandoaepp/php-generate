...
<body>
  ...
  <form id="form1" name="form1" method="post" action="creandoarchivos.php" onsubmit="return confirmar();">
    <table width="790" height="59" border="0">
      ...
      <tr>
        <td>
          <table width="177" border="0" style="float:left">
            <tr>
       ...
       ?></td>
        ...
        ?>
          <table width="528" border="0" style="float:left">
            ...
            <tr>
              <td>
                <table width="521" height="55" border="1">
                  <tr>
                    <td colspan="4"><input type="button" name="bttodo" id="bttodo" value="Seleccionar Todo"
                        onclick="ckb('form1','true')" />
                      <input type="button" name="btlimpiar" id="btlimpiar" onclick="ckb('form1','false')"
                        value="Limpiar Seleccion" /></td>
                  </tr>
                  <tr>
              ...
              ?>
               ...
               ?>>
                    ...
                    <td><label>
                        <input name="tmostrar<?=$i?>" type="text" id="tmostrar<?=$i?>"
                          value="<?=$rpta['cuerpo'][$i]['Field']?>" size="13" />
                      </label></td>
                  </tr>
                  <?php
