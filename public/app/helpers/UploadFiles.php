...
class UploadFiles
{
  ...
  //  static public function uploadFile($file, $path_url_img = 'img_admin', $path_root = '../../')
  public static function uploadFile(&$file, $path_relative = '', $pre_name = "")
  {
  ...
  public static function uploadMultiFiles(&$files_arry, $path_relative = '', $last_name = "", $name_images = array())
  {
      ...
      if (count($img_desc) > 0) {
        ...
        foreach ($img_desc as $key => $file) {
          if (!empty($file['tmp_name']) && $file['tmp_name'] != "") {
            ...
            # new name and url imgen
            if (count($name_images) > 0) {
              $name_image_item = UrlHelper::urlFriendly($name_images[$key]);
              $new_name = $name_image_item . mt_rand(1000, 9999) . "-" .  $last_name .".{$extension}";
            } else {
              $new_name = $last_name . date('YmdHms', time()) . mt_rand(1000, 9999) . ".{$extension}";
            }
  ...
  public static function removeFile($path_file)
  {
