...
class Users extends ClsConexion {
    # CONSTRUCT 
    ...
    public function updateEstado($bean_users)
    {
        try{
            $id = $bean_users->getId();
            $estado = $bean_users->getEstado();
    ...
    public function getById($bean_users)
    {
        try{
            $id = $bean_users->getId();
    ...
    public function deleteById($bean_users)
    {
        try{
            ...
            $this->query = "DELETE FROM users WHERE id = '$id' LIMIT 1";
