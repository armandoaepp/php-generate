              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/configuracion/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
