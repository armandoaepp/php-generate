...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/configuracion/configuracion.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <!-- <a href="admin/configuracion/configuracion.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/configuracion/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
          ...
          <div class="col-12">
            ...
            <table id="dataTableList" class="table table-striped table-bordered" style="width:100%">
              <thead>
                <tr>
                  <th width="50">Configuracion_id </th>
                  <th>Titulo </th>
                  <!-- <th>Horario </th> -->
                  <!-- <th>Direccion </th> -->
                  <th>Email </th>
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row["configuracion_id"] ?> </td>
                  ...
                  <td> <?php echo $row["show_popup"] ?> </td> -->
                  <td> ... </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/configuracion/editar.php?id=<?php echo $row["configuracion_id"] ?>" title="Editar">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <!-- <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row["configuracion_id"] ?>, `<?php echo $row['titulo'] ?>`,`<?php echo $title_estado ?>`,`<?php echo $row['estado'] ?>`);" title="<?php echo $title_estado ;?>">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/configuracion/IndexConfiguracion.php",
        dataType: "json",
        type: "post",
