    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/taller/taller.php" class="btn btn-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/taller/nuevo.php" class="btn btn-primary btn-sm btn-bar" role="button">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <a class="btn btn-primary btn-sm lh-1 " href="admin/taller/editar.php?id=<?php echo $row["id"] ?>"
            title="Editar">
