  ...
  <div class="app-wrap">
    ...
    <main role="main" class="main">
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          <div class="col-12">
            <h5 class="page-header-title">Lista de
              <?php echo $title_page; ?>
            </h5>
          </div>
                ...
                <tbody>
                  ...
                  <td> <?php echo $row["glosa"] ?> </td> -->
                    ...
                    <td class="text-center">
                      <span class="sr-only">
                        <?php echo $row["publicar"] ?></span>
                      <button onclick="modalPublicar(<?php echo $row['id'] ?>, `<?php echo $row['titulo'];?>` ,`<?php echo $title ?>`, `<?php echo $row['publicar'] ?>`);"
                        class="btn btn-sm lh-1 btn-table <?php echo $classBtn.' ' .$class_disabled; ; ?> " title="<?php echo $title; ?>">
                        <?php echo $icon_pub ;?>
                      </button>
                    </td>
