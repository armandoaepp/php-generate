...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/buzon-retiro/buzon_retiro.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/buzon-retiro/buzon_retiro.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/buzon-retiro/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            ...
            <table id="dataTableList" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row["titulo_retiro"] ?> </td>
                  <td> <?php echo $row["email"] ?> </td>
                  <td> <?php echo $row["mensaje"] ?> </td>
                  <td> <?php echo $row["fecha"] ?> </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/buzon_retiro/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row["id"] ?>, `<?php echo $row['nombres'] ?>`,`<?php echo $title_estado ?>`,`<?php echo $row['estado'] ?>`);" title="<?php echo $title_estado ;?>">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/buzon_retiro/IndexBuzonRetiro.php",
        dataType: "json",
        type: "post",
