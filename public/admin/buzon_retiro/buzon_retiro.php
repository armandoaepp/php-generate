<?php
    ...
    $title_page = "buzon_retiros"

?>

<?php $title_page = "BuzonRetiros" ; ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">
          <a href="admin/buzon-retiro/buzon_retiro.php">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/buzon_retiro/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
