    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/user/user.php" class="btn btn-primary btn-sm btn-bar" role="button">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <a class="btn btn-primary btn-sm lh-1 " href="admin/user/editar.php?id=<?php echo $row["user_id"] ?>"
            title="Editar">
            <i class="material-icons">edit</i>
          </a>
        </td>
        <td class="text-center">
          <button class="btn btn-danger btn-sm lh-1" onclick="modalDelete(<?php echo $row["user_id"] ?>, `aqui va el texto`);"
            title="Eliminar">
