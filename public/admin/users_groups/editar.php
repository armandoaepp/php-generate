...
<?php
  ...
  $users_groups = $users_groups_controller->find($id);

  $title_page = "UsersGroups"
?>
    ...
    <div class="container py-2 py-md-3">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-10">
          <form action="admin/users-groups/update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="user_id" id="user_id" required placeholder="user_id"  value="<?php echo $users_groups['user_id'] ?>" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="group_id">group_id : </label>
                  <input type="text" class="form-control" name="group_id" id="group_id" required placeholder="group_id"  value="<?php echo $users_groups['group_id'] ?>" >
                </div>
              </div>
