    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/departamentos/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="custom-select" name="region_id" id="region_id" placeholder="Región">
                    ...
                    <option value="<?php echo $row->region_id; ?>" <?php if( $ubigeo->region_id == $row->region_id ) echo "selected" ?> > <?php echo $row->nombre; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
