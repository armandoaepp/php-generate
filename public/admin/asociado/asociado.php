...
<body>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/asociado/asociado.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/asociado/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/asociado/IndexAsociado.php",
        dataType: "json",
        type: "post",
