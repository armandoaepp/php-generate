...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/paquete-adicional/paquete-adicional.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/paquete-adicional/paquete-adicional.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/paquete-adicional/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
          ...
          <div class="col-12">
            ...
            <table id="dataTableList" class="table table-striped table-bordered" style="width:100%">
              <thead>
                <tr>
                  <th width="50">Paquete_adicional_id </th>
                  <th>Paquete_id </th>
                  <th>Adicional_id </th>
                  <th width="70"></th>
                </tr>
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row->paquete_adicional_id ?> </td>
                  <td> <?php echo $row->paquete_id ?> </td>
                  <td> <?php echo $row->adicional_id ?> </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/paquete-adicional/editar.php?id=<?php echo $row->paquete_adicional_id ?>" title="Editar">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row->paquete_adicional_id ?>, `<?php echo $row->paquete_id ?>`,`<?php echo $title_estado ?>`,`<?php echo $row->estado ?>`);" title="<?php echo $title_estado ;?>">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/paquete-adicional/IndexPaqueteAdicional.php",
        dataType: "json",
        type: "post",
