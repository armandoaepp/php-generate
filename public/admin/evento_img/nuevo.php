    ...
    <div class="container py-2 py-md-3">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-10">
          <form action="admin/evento-img/save.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_padre" id="id_padre" required placeholder="id_padre">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
