<?php
    ...
    $title_page = "evento_imgs"

?>

<?php $title_page = "EventoImgs" ; ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">
          <a href="admin/evento-img/evento_img.php">
    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/evento-img/evento_img.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/evento-img/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/evento_img/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
                      <i class="material-icons">edit</i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row["id"] ?>, `<?php echo $row['imagen'] ?>`,`<?php echo $title_estado ?>`,`<?php echo $row['estado'] ?>`);" title="<?php echo $title_estado ;?>">
  ...
  <script>
    ...
    (function ($) {
      function processFormModal(event) {
        ...
        $.ajax({
          url: "./app/api/evento_img/IndexEventoImg.php",
          dataType: "json",
          type: "post",
