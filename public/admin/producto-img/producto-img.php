...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/producto-img/producto-img.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/producto-img/producto-img.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/producto-img/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
          ...
          <div class="col-12">
            ...
            <table id="dataTableList" class="table table-sm table-hover table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th width="50">Producto_img_id </th>
                  <th>Producto_id </th>
                  <th>Jerarquia </th>
                  <th>Imagen </th>
                  <th>Descripcion </th>
              ...
              <tbody>
                <?php foreach ($data as &$row) {?>
                  ...
                  <?php
                    ...
                    if(!empty($row->pi_publicar)){
                      if($row->pi_publicar == "S"){
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row->producto_img_id ?> </td>
                  <td> <?php echo $row->producto_id ?> </td>
                  <td> <?php echo $row->pi_jerarquia ?> </td>
                  <td> <?php echo $row->pi_imagen ?> </td>
                  <td> <?php echo $row->pi_descripcion ?> </td>
                  <td> <?php echo $row->pi_estado ?> </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/producto-img/editar.php?id=<?php echo $row->producto_img_id ?>" title="Editar">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row->producto_img_id ?>, `<?php echo $row->producto_id ?>`,`<?php echo $title_estado ?>`,`<?php echo $row->pi_estado ?>`);" title="<?php echo $title_estado ;?>">
                    <i class="far fa-trash-alt"></i>
                    </button>
                    <span class="sr-only"><?php echo $row->pi_estado ?></span>
                  </td>
                </tr>
                <?php }?>
              </tbody>
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/producto-img/IndexProductoImg.php",
        dataType: "json",
        type: "post",
