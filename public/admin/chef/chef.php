    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/chef/chef.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/chef/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/chef/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
  ...
  <script>
    ...
    (function ($) {
      function processFormModal(event) {
        ...
        $.ajax({
          url: "./app/api/chef/IndexChef.php",
          dataType: "json",
          type: "post",
