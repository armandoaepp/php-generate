    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/reservacion/save.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tipo_habitacion_id" id="tipo_habitacion_id" placeholder="TipoHabitacionId">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cuidad_origen" id="cuidad_origen" placeholder="CuidadOrigen">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="fecha_llegada">FechaLlegada: </label>
                  <input type="text" class="form-control" name="fecha_llegada" id="fecha_llegada" placeholder="FechaLlegada">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="fecha_salida">FechaSalida: </label>
                  <input type="text" class="form-control" name="fecha_salida" id="fecha_salida" placeholder="FechaSalida">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
