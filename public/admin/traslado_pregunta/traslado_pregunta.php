<?php
    ...
    $title_page = "traslado_preguntas"

?>

<?php $title_page = "TrasladoPreguntas" ; ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">
          <a href="admin/traslado-pregunta/traslado_pregunta.php">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/traslado_pregunta/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
