                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="descripcion" id="descripcion" required
                      placeholder="descripcion" value="<?php echo $taller['descripcion'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="certificacion" id="certificacion" required
                      placeholder="certificacion" value="<?php echo $taller['certificacion'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inversion" id="inversion" required
                      placeholder="inversion" value="<?php echo $taller['inversion'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="titulacion" id="titulacion" required
                      placeholder="titulacion" value="<?php echo $taller['titulacion'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalleduracion" id="detalleduracion" required
                      placeholder="detalleduracion" value="<?php echo $taller['detalleduracion'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalledia" id="detalledia" required
                      placeholder="detalledia" value="<?php echo $taller['detalledia'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detallehorario" id="detallehorario" required
                      placeholder="detallehorario" value="<?php echo $taller['detallehorario'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detallelugar" id="detallelugar" required
                      placeholder="detallelugar" value="<?php echo $taller['detallelugar'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalleprecio" id="detalleprecio" required
                      placeholder="detalleprecio" value="<?php echo $taller['detalleprecio'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalleequipos" id="detalleequipos" required
                      placeholder="detalleequipos" value="<?php echo $taller['detalleequipos'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalleconsultas" id="detalleconsultas" required
                      placeholder="detalleconsultas" value="<?php echo $taller['detalleconsultas'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detalledirigido" id="detalledirigido" required
                      placeholder="detalledirigido" value="<?php echo $taller['detalledirigido'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nombreseo" id="nombreseo" required
                      placeholder="nombreseo" value="<?php echo $taller['nombreseo'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
