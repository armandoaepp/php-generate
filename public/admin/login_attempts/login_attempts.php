<?php
    ...
    $title_page = "login_attemptss"

?>

<?php $title_page = "LoginAttemptss" ; ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">
          <a href="admin/login-attempts/login_attempts.php">
    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/login-attempts/login_attempts.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/login-attempts/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/login_attempts/editar.php?id=<?php echo $row["id"] ?>" title="Editar">
  ...
  <script>
    ...
    (function ($) {
      function processFormModal(event) {
        ...
        $.ajax({
          url: "./app/api/login_attempts/IndexLoginAttempts.php",
          dataType: "json",
          type: "post",
