    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/habitacion-img/save.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="habitacion_id" id="habitacion_id" placeholder="HabitacionId">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="jerarquia">Jerarquia: </label>
                  <input type="text" class="form-control" name="jerarquia" id="jerarquia" placeholder="Jerarquia">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="desc_imagen">DescImagen: </label>
                  <input type="text" class="form-control" name="desc_imagen" id="desc_imagen" placeholder="DescImagen">
                </div>
              </div>
