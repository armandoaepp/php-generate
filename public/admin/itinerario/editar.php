    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/itinerario/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dia" id="dia" placeholder="Dia" value="<?php echo $itinerario->dia; ?>">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="titulo">Titulo: </label>
                  <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Titulo" value="<?php echo $itinerario->titulo; ?>">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="descripcion">Descripcion: </label>
                  <textarea class="form-control ckeditor" name="descripcion" id="descripcion" placeholder="Descripcion" cols="30" rows="6"><?php echo htmlspecialchars_decode($itinerario->descripcion); ?></textarea>
                </div>
              </div>
