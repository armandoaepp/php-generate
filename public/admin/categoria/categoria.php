            ...
            <table id="dataTableList" class="table table-sm table-hover table-bordered dt-responsive nowrap" style="width:100%">
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <!-- <td> <?php echo $row->cat_imagen ?> </td> -->
                  <!-- <td> <?php echo $row->cat_publicar ?> </td> -->
                  <!-- <td> <?php echo $row->cat_estado ?> </td> -->

                  <td class="text-center">
                    <span class="sr-only"><?php echo $row->cat_publicar ?></span>
                    <button onclick="modalPublicar(<?php echo $row->categoria_id ?>, `<?php echo $row->cat_nombre ?>` ,`<?php echo $title ?>`, `<?php echo $row->cat_publicar ?>`);" class="btn btn-sm lh-1 btn-table <?php echo $classBtn.' ' .$class_disabled; ; ?> " title="<?php echo $title; ?>" >
                    <?php echo $icon_pub ;?>
                    </button>
                  </td>
                  ...
                  <td class="text-center">
                    ...
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row->categoria_id ?>, `<?php echo $row->cat_nombre ?>`,`<?php echo $title_estado ?>`,`<?php echo $row->cat_estado ?>`);" title="<?php echo $title_estado ;?>">
                    <i class="far fa-trash-alt"></i>
                    </button>
                    <span class="sr-only"><?php echo $row->cat_estado ?></span>
                  </td>
                </tr>
                <?php }?>
              </tbody>
