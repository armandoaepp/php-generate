            ...
            <form action="admin/categoria/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="desc_categoria">DescCategoria: </label>
                  <input type="text" class="form-control" name="desc_categoria" id="desc_categoria" placeholder="DescCategoria" value="<?php echo $categoria->desc_categoria; ?>">
                </div>
              </div>
