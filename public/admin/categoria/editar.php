...
<?php
  ...
  $publicar = trim($categoria->cat_publicar);
            ...
            <form action="admin/categoria/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cat_nombre" id="cat_nombre" placeholder="Nombre" value="<?php echo $categoria->cat_nombre; ?>">
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="cat_publicar" id="si" value="S" <?php echo $si; ?> >
                    <label class="form-check-label" for="si">SI</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="cat_publicar" id="no" value="N" <?php echo $no; ?> >
