<?php
  ...
  $convenio_img = $convenio_img_controller->getByConvenioId($params);
        ...
        <div class="row">
          <div class="col-12">
            <h5 class="page-header-title">Editar
              <?php echo $title_page; ?> Imagenes</h5>
              <hr>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-12 col-xl-12">
            <form action="admin/convenio/save-images.php" method="POST" enctype="multipart/form-data">
              <input type="hidden" class="form-control" name="accion" id="accionForm" value="edit">
              <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $id ?>">
              <div class="row">

                <div class="col-md-12 fw-600">
                  <label for="titulo">Convenio : </label>
                  <?php echo $convenio->nombre ?>
                </div>
                ...
                <div class="col-12">
                  <div id="sortable" class="row my-2">
                    ...
                    <?php
                      foreach ($convenio_img as $index => &$images) {
                    ?>
                    ...
                    <div class="col-6 col-sm-3 col-md-2 mb-3 ">
                      <div class="card ui-state-default">
                        ...
                        <input type="hidden" name="ids_convenio_img[]" value="<?php echo $images->convenio_img_id; ?>">
                        ...
                        <button type="button" class="close close-danger ml-auto" title="Eliminar" aria-label="Close"
                          onclick="event.preventDefault(); deleteItemImg(<?php echo $images->convenio_img_id; ?>)">
