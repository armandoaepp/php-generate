<?php
    ...
    $data = $marca_controller->getAll();

    $title_page = "marcas"

?>

<?php $title_page = "Marcas" ; ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/marca/marca.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/marca/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              ...
              <tbody>
                ...
                <tr class="<?php if($row["estado"] == 0 ) echo "tr-estado" ;?>" >
                  ...
                  <td class="text-center">
                    ...
                    <button onclick="modalPublicar(<?php echo $row['idmarca'] ?>, `<?php echo $row['nombre'] ?>` ,`<?php echo $title ?>`, `<?php echo $row['publicar'] ?>`);" class="btn btn-primary btn-sm lh-1 btn-table <?php echo $classBtn; ?> " title="<?php echo $title; ?>" >
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table" href="admin/marca/editar.php?id=<?php echo $row["idmarca"] ?>" title="Editar">
                      <i class="material-icons">edit</i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row["idmarca"] ?>, `<?php echo $row['nombre'] ?>`,`<?php echo $title_estado ?>`,`<?php echo $row['estado'] ?>`);" title="<?php echo $title_estado ;?>">
  ...
  <script>
    ...
    (function ($) {
      function processFormModal(event) {
        ...
        $.ajax({
          url: "./app/api/marca/IndexMarca.php",
          dataType: "json",
          type: "post",
