...
<?php
  ...
  $marca = $marca_controller->find($id);
  ...
  <main role="main" class="screen-main">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="admin/marca/marca.php"><?php echo $title_page ;?>s</a>
        </li>
    ...
    <div class="container py-2 py-md-3">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-10">
          <form action="admin/marca/update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" id="nombre" required placeholder="nombre"  value="<?php echo $marca['nombre'] ?>" >
                </div>
              </div>
            ...
            <div class="w-100 text-center">
              <a href="admin/marca/marca.php" type="button" class="btn btn-dark ">Cancelar</a>
