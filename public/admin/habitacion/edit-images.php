...
$habitaciones_img = $habitacion_img_controller->getByHabitacionId($params);

$title_page = "Habitacion Images ";
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-12">
            <form action="admin/habitacion/save-images.php" method="POST" enctype="multipart/form-data">
              <input type="hidden" class="form-control" name="accion" id="accionForm" value="edit">
              <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $id ?>">
              <div class="row">

                <div class="col-md-12">
                  <label for="titulo">Habitacion : </label>
                ...
                <div class="col-12">
                  ...
                  <div id="sortable" class="row my-2">
                    <?php
                    foreach ($habitaciones_img as $index => &$images) {
                    ?>

                    <!-- <div class="col-6 col-sm-3 col-md-2 mb-3 "> -->
                      <!-- <div class="card ui-state-default">
                        <span class="icon-move"> <i class="fas fa-arrows-alt"></i> </span>
                        <input type="hidden" name="ids_habitaciones_img[]" value="<?php echo $images->id; ?>">
                      ...
                      <!-- <div class="preview-img card ui-state-default border-0 bg-transparent" > -->
                        <div class="preview-item-image card ui-state-default border-0 bg-transparent">
                          ...
                          <input type="text" class="form-control" name="desc_images[]" value="hab-simple-tina-agua-caliente">
                          <button type="button" class="close close-danger ml-auto" title="Eliminar" aria-label="Close"
                            onclick="event.preventDefault(); deleteItemImg(<?php echo $images->habitacion_img_id; ?>)">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                      <!-- </div> -->
                ...
                <div class="col-12 mb-3">
                  ...
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <input data-file-img="images" data-id="preview-images" type="file" class="form-control" name="imagen[]"
