...
<?php
  ...
  $tipo_publicacion = $tipo_publicacion_controller->find($id);

  $publicar = trim($tipo_publicacion->publicar);
    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/tipo-publicacion/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Descripcion" value="<?php echo $tipo_publicacion->descripcion; ?>">
                </div>
              </div>
