  ...
  <main role="main" class="screen-main">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="admin/textos/textos.php"><?php echo $title_page ;?>s</a>
        </li>
    ...
    <div class="container py-2 py-md-3">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-10">
          <form action="admin/textos/save.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="identificador" id="identificador" required placeholder="identificador">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
