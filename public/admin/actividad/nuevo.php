    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/actividad/save.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control ckeditor" name="descripcion" id="descripcion" placeholder="Descripcion" ></textarea>
                </div>
              </div>
