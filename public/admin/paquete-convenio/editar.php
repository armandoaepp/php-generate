...
<?php
  ...
  $paquete_convenio = $paquete_convenio_controller->find($id);

  $title_page = "PaqueteConvenio";
    ...
    <main role="main" class="main">
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item">
            <a href="admin/paquete-convenio/paquete-convenio.php">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/paquete-convenio/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="w-100 text-center">
                <a href="admin/paquete-convenio/paquete-convenio.php" class="btn btn-outline-danger"> <i class="fas fa-times"></i> Cancelar</a>
