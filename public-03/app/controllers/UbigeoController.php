 ...
 class UbigeoController
{
  ...
  public function getDepartamentosByPaisId( $params = array() )
  {
    try
    {
      extract($params) ;
      ...
      $data = $ubigeo->getDepartamentosByPaisId($bean_ubigeo);
  ...
  public function getProvinciasByDepartamentoId( $departamento_id )
  {
    try
    {
      ...
      // $bean_ubigeo->setPaisId($departamento_id);

      $data = $ubigeo->getProvinciasByDepartamentoId($departamento_id);
  ...
  public function getDistritosByDepartamentoId( $departamento_id )
  {
    try
    {
      ...
      $data = $ubigeo->getDistritosByDepartamentoId($departamento_id);
  ...
  public function getDepartamentosForPaquetesExisting(  )
  {
    try
    {
      ...
      $data = $ubigeo->getDepartamentosForPaquetesExisting();
  ...
  public function findName($nombre)
  {
    try
    {
      ...
      $data = $ubigeo->findName( $bean_ubigeo) ;
      return $data;
  ...
  public function getCaseriosByPaisId( $params = array() )
  {
    try
    {
      extract($params) ;
      ...
      $data = $ubigeo->getCaseriosByPaisId($bean_ubigeo);
  ...
  public function getSectoresByPaisId( $params = array() )
  {
    try
    {
      extract($params) ;
      ...
      $data = $ubigeo->getSectoresByPaisId($bean_ubigeo);
  ...
  public function getUbigeoIdPadreAndTipo($params = array())
  {
    try
    {
      ...
      $data = $ubigeo->getUbigeoIdPadreAndTipo($bean_ubigeo) ;
