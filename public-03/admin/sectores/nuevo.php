    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/sectores/save.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="caserio_id">Caserio: </label>
                  <select class="custom-select js-select2" name="caserio_id" id="caserio_id" placeholder="Distrito" required>
                    <option value="" selected disabled hidden>Seleccionar </option>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Sector" required maxlength="255">
                </div>
              </div>
