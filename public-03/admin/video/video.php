...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/video/video.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/video/video.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/video/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            ...
            <table id="dataTableList" class="table table-sm table-hover table-bordered dt-responsive nowrap" style="width:100%">
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row->tipo_video ?> </td>
                  <td> <?php echo $row->url ?> </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/video/editar.php?id=<?php echo $row->video_id ?>" title="Editar">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm lh-1 btn-table" onclick="modalDelete(<?php echo $row->video_id ?>, `<?php echo $row->titulo ?>`,`<?php echo $title_estado ?>`,`<?php echo $row->estado ?>`);" title="<?php echo $title_estado ;?>">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/video/IndexVideo.php",
        dataType: "json",
        type: "post",
