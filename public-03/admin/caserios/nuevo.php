...
<?php
  ...
  $disitritos = $ubigeo_controller->getDistritosByPaisId($array);
    ...
    <main role="main" class="main">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/caserios/save.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="custom-select js-select2" name="distrito_id" id="distrito_id" placeholder="Distrito">
                    <option value="" selected disabled hidden>Seleccionar </option>
                    <?php foreach ($disitritos as $row) { ?>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="nombre">Caserio: </label>
                  <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Caserio" required maxlength="255">
                </div>
              </div>
