    ...
    <main role="main" class="main">
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item">
            <a href="admin/caserios/caserios.php">
      ...
      <div class="container py-2 py-md-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <form action="admin/caserios/update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="distrito_id" id="distrito_id" placeholder="Distrito">
                      <option value="" selected disabled hidden>Seleccionar </option>
              ...
              <div class="w-100 text-center">
                <a href="admin/caserios/caserios.php" class="btn btn-outline-danger"> <i class="fas fa-times"></i> Cancelar</a>
