    ...
    <div class="container py-2">
      <div class="row">
        ...
        <div class="col-12 mb-3">
          <a href="admin/home/home.php" class="btn btn-primary btn-sm btn-bar" role="button">
            <i class="material-icons ">format_list_bulleted</i> Listar
          </a>
          <a href="admin/home/nuevo.php" class="btn btn-primary btn-sm btn-bar" role="button">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <a class="btn btn-primary btn-sm lh-1 " href="admin/home/editar.php?id=<?php echo $row["id"] ?>"
            title="Editar">
